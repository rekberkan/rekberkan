...
export class WithdrawDto {
  ...
  @ApiProperty({
    description:
      "Bank account ID linked to the user (optional if providing bank details)",
  ...
  @IsString()
  @IsNotEmpty({
    message: "Bank code is required when not using saved bank account",
  })
  bankCode?: string;
  ...
  @IsString()
  @IsNotEmpty({
    message: "Account number is required when not using saved bank account",
  })
  ...
  @IsString()
  @IsNotEmpty({
    message: "Account name is required when not using saved bank account",
  })
  accountName?: string;
}
