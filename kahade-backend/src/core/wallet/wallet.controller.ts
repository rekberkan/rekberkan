...
export class WalletController {
  ...
  @ApiOperation({ summary: 'Get detailed wallet balance including locked funds' })
  ...
  async withdraw(@CurrentUser('id') userId: string, @Body() withdrawDto: WithdrawDto) {
    ...
    if (withdrawDto.amount > 50000000) {
      throw new BadRequestException('Maximum withdrawal amount is Rp 50,000,000 per transaction');
    }
