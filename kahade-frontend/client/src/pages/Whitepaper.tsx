          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <div className="relative bg-white rounded-2xl shadow-2xl p-8 transform rotate-2 hover:rotate-0 transition-transform">
                <div className="absolute top-4 right-4 w-12 h-12 rounded-xl bg-accent/10 flex items-center justify-center">
                  <FileText className="w-6 h-6 text-accent" weight="fill" />
                </div>
              ...
              <div className="absolute -bottom-4 -left-4 bg-secondary rounded-2xl p-6 shadow-lg">
                <div className="text-3xl font-bold gradient-text">v2.0</div>
            ...
            {highlights.map((item, index) => (
              ...
              >
                <div className="w-12 h-12 rounded-xl bg-accent/10 flex items-center justify-center mx-auto mb-4">
                  <item.icon className="w-6 h-6 text-accent" weight="fill" />
                </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12">
              ...
              <div className="space-y-3">
                {tableOfContents.map((item, index) => (
                  <motion.div
                    ...
                    className="flex items-center justify-between p-4 rounded-xl bg-white hover:bg-accent/5 transition-colors cursor-pointer group"
                  >
            ...
            >
              <div className="glass-card p-8 sticky top-24">
                ...
                <Button size="lg" className="w-full btn-accent gap-2">
                  <Download className="w-5 h-5" weight="bold" />
                  Download Whitepaper
                </Button>
              </div>
