        ...
        <div className="container">
            ...
            {filteredPosts.map((post, index) => (
              ...
              >
                <div className="h-48 bg-gradient-to-br from-secondary to-secondary/50 flex items-center justify-center">
                  <Lightbulb className="w-12 h-12 text-muted-foreground/50 group-hover:text-accent transition-colors" weight="fill" />
                </div>
                <div className="p-6">
          ...
          {filteredPosts.length === 0 && (
            <div className="text-center py-12">
              <BookOpen className="w-16 h-16 mx-auto text-muted-foreground/50 mb-4" weight="regular" />
